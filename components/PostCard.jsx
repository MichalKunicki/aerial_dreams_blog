...
const PostCard = ({ post }) => {
  return (
    <div className="relative mb-8 rounded-lg border-2 border-neutral-800 bg-neutral-900 p-0 pb-12 shadow-lg lg:p-8">
      ...
      <div className="text-center">
        <Link href={`/post/${post.slug}`}>
          <span className="inline-block transform cursor-pointer rounded-full bg-orange-600 px-6 py-2 text-lg font-medium text-white transition duration-500 hover:-translate-y-1">
            Continue Reading
          </span>
        </Link>
      </div>
